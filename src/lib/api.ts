...
export function useGetDashboardSummary() {
  return useQuery({ queryKey: ["dashboard", "summary"], queryFn: () => get<any>("/api/dashboard/summary") });
}
export function useGetExchangeRates() {
  return useQuery({ queryKey: ["dashboard", "rates"], queryFn: () => get<any>("/api/dashboard/rates") });
}
