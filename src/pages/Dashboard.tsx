      ...
      <div className="relative border border-white/10 p-4 md:p-8 flex flex-col gap-6 bg-transparent">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-3">
            <button className="border-white/30 text-white hover:bg-white hover:text-black font-mono text-[10px] uppercase tracking-widest rounded-none px-3 py-2 border transition-colors">
              [↙ RECEIVE]
            </button>
            <button className="border-white/30 text-white hover:bg-white hover:text-black font-mono text-[10px] uppercase tracking-widest rounded-none px-3 py-2 border transition-colors">
              [↗ SEND]
        ...
        {/* Stats row — stacks on mobile, row on desktop */}
